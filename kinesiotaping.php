...
<body>
  ...
  <main>
    <div class="container" id="kinesiotaping-container">
        ...
        (bogatej w liczne naczynia krwionośne, chłonne oraz receptory nerwowe) pomiędzy tkanką skórną a przyległą tkanką mięśniową poprawiając mikrokrążenie, a co za tym idzie lepsze odżywianie 
        danej okolicy aktywując procesy samoleczenia organizmu.
				</div>
			</div>
		</div>
  </main>
